...
{#if type === 'bug'}
	<svg
		id="bug-type-icon"
		class="svg-icon svg-type-icon"
		data-name="bug-type-icon"
...
{#if type === 'dark'}
	<svg
		id="dark-type-svg-icon"
		class="svg-icon svg-type-icon"
		data-name="type-svg-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 256 256"
	>
		<circle class="cls-2" cx="128" cy="128" r="128" />
...
{#if type === 'fairy'}
	<svg
		id="fairy-type-svg-icon"
		class="svg-icon svg-type-icon"
		data-name="fairy-type-svg-icon"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 256 256"
	>
		<circle class="cls-2" cx="128" cy="128" r="128" />
